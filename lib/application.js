...
module.exports = class Application extends Emitter { // 在异常发生时要弹出异常信息，因此继承了 Emitter
  /**
  ...
  constructor(options) {
    ...
    this.middleware = []; // 声明了中间件数组
    this.context = Object.create(context); // 成员变量 context 继承了 context 对象
